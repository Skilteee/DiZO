...
class Framework:
    ...
    def train(self, train_samples, eval_samples):
        ...
        if self.args.only_train_option and not self.args.non_diff and self.args.trainer != "zo":
        ...
        # self.model.load_state_dict(trainer.best_model_ckpt)
...
def main():
    ...
    if args.train_set_seed is not None or args.num_train_sets is not None:
        ...
        for train_set_id, train_samples in enumerate(train_sets):
            ...
            eval_samples = task.samples['test']
            ...
            if args.trainer != "none":
                if args.num_dev is not None:
                    ...
                    dev_samples = task.samples['valid']
                else:
                    dev_samples = None
